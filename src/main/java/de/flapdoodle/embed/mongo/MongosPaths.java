 ...
 *
 */
public class MongosPaths implements IPackageResolver {

	private static Logger logger = Logger.getLogger(MongosPaths.class.getName());
	...
	public String executableFilename(Distribution distribution) {
		...
		switch (distribution.getPlatform()) {
			case Linux:
				mongodPattern = "mongos";
				break;
			case Windows:
				mongodPattern = "mongos.exe";
				break;
			case OS_X:
				mongodPattern = "mongos";
				break;
