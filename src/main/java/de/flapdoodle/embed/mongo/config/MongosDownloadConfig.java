...
import de.flapdoodle.embed.mongo.MongosPaths;
...
public class MongosDownloadConfig implements IDownloadConfig {
	...
	private IPackageResolver packageResolver=new MongosPaths();
